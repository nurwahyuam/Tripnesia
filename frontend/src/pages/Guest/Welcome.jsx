        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <nav className="flex flex-wrap items-center gap-6 md:gap-8 justify-center">
              <a href="#book" className="text-gray-600 hover:text-blue-600 font-medium transition-colors">
                Book & Boat
              </a>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center text-white">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Relax Your Way Through Raja Ampat
            </h1>
              ...
              <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-end">
                ...
                <div className="w-full md:w-auto">
                  ...
                  <div className="flex items-center border border-gray-300 rounded-lg px-4 py-3 bg-white">
                    <button
                      className="text-blue-600 hover:text-blue-700 text-xl font-bold w-8 h-8 flex items-center justify-center"
                      onClick={() => setPassengerCount(Math.max(1, passengerCount - 1))}
                    >
                      -
                    </button>
                    <span className="mx-4 text-gray-700 font-medium min-w-8 text-center">
                      {passengerCount}
                    </span>
                    <button
                      className="text-blue-600 hover:text-blue-700 text-xl font-bold w-8 h-8 flex items-center justify-center"
                ...
                <button className="px-8 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium w-full md:w-auto">
                  Search
                </button>
              </div>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-800 mb-4">
            Why Choose TripNesia!
          </h2>
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Experience the best of Raja Ampat with our trusted services and expert guidance
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {trips.map((trip) => (
              ...
              >
                ...
                <button className="w-full py-3 border border-blue-600 text-blue-600 rounded-lg hover:bg-blue-600 hover:text-white transition-colors font-medium">
                  Share More
                </button>
              </div>
            ))}
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-center md:text-right">
              ...
              <p className="text-gray-400">
                Experience the beauty of Indonesia with us
              </p>
            </div>
          </div>
        </div>
